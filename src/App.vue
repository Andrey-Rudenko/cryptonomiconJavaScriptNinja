<template>
  ...
  <div class="container">
    <section>
      <div class="flex">
        <div class="max-w-xs">
          ...
          <div class="mt-1 relative rounded-md shadow-md">
            <h2>{{ newValueTicker }}</h2>
            <input
              @keydown.enter="addTicker"
              v-model="newValueTicker"
              type="text"
              name="wallet"
              id="wallet"
      ...
      <hr v-if="listOfTickers.length" class="w-full border-t border-gray-600 my-4" />
      <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
        <div v-for="tick in listOfTickers" :key="tick.value"
          :class="{
            'border-4' : sel === tick
        ...
        >
          ...
          <button @click.stop="deleteTicker(tick)"
...
<style src="./cryptonomicon-html/app.css"></style>
